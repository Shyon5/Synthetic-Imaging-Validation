...
For an NVIDIA CUDA environment, use the command generated by the
[official PyTorch installer](https://pytorch.org/get-started/locally/) for your
OS and CUDA version, then install this package. For example, if the PyTorch
selector recommends the CUDA 12.8 wheel index:
